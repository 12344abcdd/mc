...
public class GlStateManager {
   ...
   public static void upload(int level, int offsetX, int offsetY, int width, int height, NativeImage.Format format, IntBuffer pixels, Consumer closer) {
   ...
   private static void _upload(int level, int offsetX, int offsetY, int width, int height, NativeImage.Format format, IntBuffer pixels, Consumer closer) {
      try {
         RenderSystem.assertOnRenderThreadOrInit();
   ...
   static {
      ON_LINUX = Util.getOperatingSystem() == OperatingSystem.LINUX;
      ...
      TEXTURES = (Texture2DState[])IntStream.range(0, 12).mapToObj((i) -> new Texture2DState()).toArray((i) -> new Texture2DState[i]);
   ...
   public static enum SrcFactor {
      ...
      private SrcFactor(final int value) {
         this.value = value;
      }
   ...
   public static enum DstFactor {
      ...
      private DstFactor(final int value) {
         this.value = value;
      }
