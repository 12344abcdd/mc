...
public final class SimpleOption {
   ...
   static {
      ...
      BOOLEAN_TEXT_GETTER = (optionText, value) -> value ? ScreenTexts.ON : ScreenTexts.OFF;
   }
   ...
   public static enum DoubleSliderCallbacks implements SliderCallbacks {
      ...
      public Optional validate(Double double_) {
         return double_ >= (double)0.0F && double_ <= (double)1.0F ? Optional.of(double_) : Optional.empty();
      }
      ...
      public Codec codec() {
         return Codec.withAlternative(Codec.doubleRange((double)0.0F, (double)1.0F), Codec.BOOL, (value) -> value ? (double)1.0F : (double)0.0F);
      }
   ...
   interface IntSliderCallbacks extends SliderCallbacks {
      ...
      default double toSliderProgress(Integer integer) {
         if (integer == this.minInclusive()) {
            ...
            return integer == this.maxInclusive() ? (double)1.0F : MathHelper.map((double)integer + (double)0.5F, (double)this.minInclusive(), (double)this.maxInclusive() + (double)1.0F, (double)0.0F, (double)1.0F);
         }
      }
      ...
      default Integer toValue(double d) {
         ...
         return MathHelper.floor(MathHelper.map(d, (double)0.0F, (double)1.0F, (double)this.minInclusive(), (double)this.maxInclusive() + (double)1.0F));
      }
   ...
   public static final class OptionSliderWidgetImpl extends OptionSliderWidget {
      ...
      public void applyPendingValue() {
         N object = (N)this.callbacks.toValue(this.value);
