...
public class Main {
   ...
   public static void main(String[] args) {
      ...
      OptionSpec<File> optionSpec6 = optionParser.accepts("gameDir").withRequiredArg().ofType(File.class).defaultsTo(new File("."), new File[0]);
      ...
      OptionSpec<Integer> optionSpec10 = optionParser.accepts("proxyPort").withRequiredArg().defaultsTo("8080", new String[0]).ofType(Integer.class);
      ...
      OptionSpec<String> optionSpec13 = optionParser.accepts("username").withRequiredArg().defaultsTo("Player" + System.currentTimeMillis() % 1000L, new String[0]);
      OptionSpec<String> optionSpec14 = optionParser.accepts("uuid").withRequiredArg();
      OptionSpec<String> optionSpec15 = optionParser.accepts("xuid").withOptionalArg().defaultsTo("", new String[0]);
      OptionSpec<String> optionSpec16 = optionParser.accepts("clientId").withOptionalArg().defaultsTo("", new String[0]);
      ...
      OptionSpec<Integer> optionSpec19 = optionParser.accepts("width").withRequiredArg().ofType(Integer.class).defaultsTo(854, new Integer[0]);
      OptionSpec<Integer> optionSpec20 = optionParser.accepts("height").withRequiredArg().ofType(Integer.class).defaultsTo(480, new Integer[0]);
      ...
      OptionSpec<String> optionSpec23 = optionParser.accepts("userProperties").withRequiredArg().defaultsTo("{}", new String[0]);
      OptionSpec<String> optionSpec24 = optionParser.accepts("profileProperties").withRequiredArg().defaultsTo("{}", new String[0]);
      OptionSpec<String> optionSpec25 = optionParser.accepts("assetIndex").withRequiredArg();
      OptionSpec<String> optionSpec26 = optionParser.accepts("userType").withRequiredArg().defaultsTo("legacy", new String[0]);
      OptionSpec<String> optionSpec27 = optionParser.accepts("versionType").withRequiredArg().defaultsTo("release", new String[0]);
      OptionSpec<String> optionSpec28 = optionParser.nonOptions();
      OptionSet optionSet = optionParser.parse(args);
      File file = (File)getOption(optionSet, optionSpec6);
      String string = (String)getOption(optionSet, optionSpec18);
      ...
      try {
         ...
         String string3 = (String)optionSpec26.value(optionSet);
         Session.AccountType accountType = Session.AccountType.byName(string3);
         if (accountType == null) {
            logger.warn("Unrecognized user type: {}", string3);
         }

         String string4 = (String)getOption(optionSet, optionSpec9);
         Proxy proxy = Proxy.NO_PROXY;
         if (string4 != null) {
            try {
               proxy = new Proxy(Type.SOCKS, new InetSocketAddress(string4, (Integer)getOption(optionSet, optionSpec10)));
            } catch (Exception var78) {
            }
         }

         final String string5 = (String)getOption(optionSet, optionSpec11);
         final String string6 = (String)getOption(optionSet, optionSpec12);
         if (!proxy.equals(Proxy.NO_PROXY) && isNotNullOrEmpty(string5) && isNotNullOrEmpty(string6)) {
            Authenticator.setDefault(new Authenticator(string5, string6) {
         ...
         String string7 = (String)getOption(optionSet, optionSpec27);
         ...
         String string9 = (String)optionSet.valueOf(optionSpec15);
         String string10 = (String)optionSet.valueOf(optionSpec16);
         String string11 = (String)getOption(optionSet, optionSpec2);
         String string12 = unescape((String)getOption(optionSet, optionSpec3));
         String string13 = unescape((String)getOption(optionSet, optionSpec4));
         String string14 = unescape((String)getOption(optionSet, optionSpec5));
         Session session = new Session((String)optionSpec13.value(optionSet), uUID, (String)optionSpec17.value(optionSet), toOptional(string9), toOptional(string10), accountType);
         runArgs = new RunArgs(new RunArgs.Network(session, propertyMap, propertyMap2, proxy), new WindowSettings(i, j, optionalInt, optionalInt2, bl), new RunArgs.Directories(file, file3, file2, string8), new RunArgs.Game(bl2, string, string7, bl3, bl4), new RunArgs.QuickPlay(string11, string12, string13, string14));
         Util.startTimerHack();
         ...
         MinecraftClient.addSystemDetailsToCrashReport((MinecraftClient)null, (LanguageManager)null, (String)string, (GameOptions)null, (CrashReport)crashReport);
