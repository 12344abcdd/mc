...
public class RepeatedNarrator {
   ...
   public void narrate(NarratorManager narratorManager, Text text) {
      Parameters parameters = (Parameters)this.params.updateAndGet((parametersx) -> parametersx != null && text.equals(parametersx.message) ? parametersx : new Parameters(text, RateLimiter.create((double)this.permitsPerSecond)));
