...
public class RealmsWorldSlotButton extends ButtonWidget {
   ...
   private void updateTooltip(State state, @Nullable String minigameName) {
      ...
      switch (state.action.ordinal()) {
         case 1 -> var10000 = state.minigame ? MINIGAME_TOOLTIP : TOOLTIP;
         case 2 -> var10000 = ACTIVE_TOOLTIP;
   ...
   public void renderWidget(DrawContext context, int mouseX, int mouseY, float delta) {
      if (this.state != null) {
         ...
         context.drawCenteredTextWithShadow(textRenderer, (String)this.state.slotName, i + 40, j + 66, -1);
         context.drawCenteredTextWithShadow(textRenderer, (Text)RealmsMainScreen.getVersionText(this.state.version, this.state.compatibility.isCompatible()), i + 40, j + 80 + 2, -1);
      }
   }
