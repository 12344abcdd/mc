...
public class RealmsClientIncompatibleScreen extends RealmsScreen {
   ...
   static {
      UNSUPPORTED_SNAPSHOT_VERSION = Text.translatable("mco.client.unsupported.snapshot.version", new Object[]{GAME_VERSION});
      OUTDATED_STABLE_VERSION = Text.translatable("mco.client.outdated.stable.version", new Object[]{GAME_VERSION});
   }
}
