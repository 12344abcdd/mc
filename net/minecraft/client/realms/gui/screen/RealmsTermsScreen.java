...
public class RealmsTermsScreen extends RealmsScreen {
   ...
   public void init() {
      ...
      this.addDrawableChild(ButtonWidget.builder(Text.translatable("mco.terms.buttons.agree"), (button) -> this.agreedToTos()).dimensions(this.width / 4, row(12), i, 20).build());
      this.addDrawableChild(ButtonWidget.builder(Text.translatable("mco.terms.buttons.disagree"), (button) -> this.client.setScreen(this.parent)).dimensions(this.width / 2 + 4, row(12), i, 20).build());
   }
   ...
   public void render(DrawContext context, int mouseX, int mouseY, float delta) {
      ...
      context.drawText(this.textRenderer, (Text)SENTENCE_ONE_TEXT, this.width / 2 - 120, row(5), -1, false);
   ...
   static {
      SENTENCE_TWO_TEXT = ScreenTexts.space().append(Text.translatable("mco.terms.sentence.2").fillStyle(Style.EMPTY.withUnderline(true)));
   }
}
