...
public class RealmsBackupInfoScreen extends RealmsScreen {
   ...
   class BackupInfoListEntry extends AlwaysSelectedEntryListWidget.Entry {
      ...
      private Text getTextFromKey(String key) {
         Text var10000;
         switch (key) {
            case "template_name" -> var10000 = TEMPLATE_NAME_TEXT;
            case "game_difficulty" -> var10000 = GAME_DIFFICULTY_TEXT;
            case "name" -> var10000 = NAME_TEXT;
            case "game_server_version" -> var10000 = GAME_SERVER_VERSION_TEXT;
            case "uploaded" -> var10000 = UPLOADED_TEXT;
            case "enabled_packs" -> var10000 = ENABLED_PACK_TEXT;
            case "description" -> var10000 = DESCRIPTION_TEXT;
            case "game_mode" -> var10000 = GAME_MODE_TEXT;
            case "seed" -> var10000 = SEED_TEXT;
            case "world_type" -> var10000 = WORLD_TYPE_TEXT;
            default -> var10000 = UNDEFINED_TEXT;
         }
   ...
   @Environment(EnvType.CLIENT)
   class BackupInfoList extends AlwaysSelectedEntryListWidget {
