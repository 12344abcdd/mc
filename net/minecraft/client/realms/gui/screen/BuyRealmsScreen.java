...
public class BuyRealmsScreen extends RealmsScreen {
   ...
   protected void init() {
      ...
      TexturedButtonWidget texturedButtonWidget = (TexturedButtonWidget)this.addDrawableChild(new TexturedButtonWidget(this.getLeft() + 4, this.getTop() + 4, 14, 14, CROSS_BUTTON_TEXTURES, (button) -> this.close(), CLOSE_TEXT));
