...
public class RealmsCreateRealmScreen extends RealmsScreen {
   ...
   private void createSnapshotWorld(long parentId) {
      Screen screen = new RealmsResetNormalWorldScreen((info) -> {
         if (info == null) {
            this.client.setScreen(this);
         } else {
            this.client.setScreen(new RealmsLongRunningMcoTaskScreen(this, new LongRunningTask[]{new CreatingSnapshotWorldTask(this.parent, parentId, info, this.nameBox.getText(), this.descriptionBox.getText())}));
         }
      }, TITLE_TEXT);
