...
public class RealmsSelectFileToUploadScreen extends RealmsScreen {
   ...
   public void init() {
      ...
      this.uploadButton = (ButtonWidget)this.addDrawableChild(ButtonWidget.builder(Text.translatable("mco.upload.button.name"), (button) -> this.upload()).dimensions(this.width / 2 - 154, this.height - 32, 153, 20).build());
   ...
   @Environment(EnvType.CLIENT)
   class WorldListEntry extends AlwaysSelectedEntryListWidget.Entry {
      ...
      public WorldListEntry(final LevelSummary summary) {
         ...
         this.nameAndLastPlayed = Text.translatable("mco.upload.entry.id", new Object[]{summary.getName(), RealmsSelectFileToUploadScreen.getLastPlayed(summary)});
      ...
      public Text getNarration() {
         Text text = ScreenTexts.joinLines(new Text[]{Text.literal(this.summary.getDisplayName()), Text.literal(RealmsSelectFileToUploadScreen.getLastPlayed(this.summary)), RealmsSelectFileToUploadScreen.getGameModeName(this.summary)});
