...
public class RealmsNotification {
   ...
   private static RealmsNotification fromJson(JsonObject json) {
      ...
      if (uUID == null) {
         ...
         Object var10000;
         switch (string) {
            case "visitUrl" -> var10000 = RealmsNotification.VisitUrl.fromJson(realmsNotification, json);
            case "infoPopup" -> var10000 = RealmsNotification.InfoPopup.fromJson(realmsNotification, json);
            default -> var10000 = realmsNotification;
         }
