...
public class FilterAtlasSource implements AtlasSource {
   public static final MapCodec CODEC = RecordCodecBuilder.mapCodec((instance) -> instance.group(BlockEntry.CODEC.fieldOf("pattern").forGetter((filterAtlasSource) -> filterAtlasSource.pattern)).apply(instance, FilterAtlasSource::new));
