...
public class AtlasLoader {
   ...
   public List loadSources(ResourceManager resourceManager) {
      ...
      AtlasSource.SpriteRegions spriteRegions = new AtlasSource.SpriteRegions() {
         ...
         public void removeIf(Predicate predicate) {
            ...
            while(iterator.hasNext()) {
               Map.Entry<Identifier, AtlasSource.SpriteRegion> entry = (Map.Entry)iterator.next();
      ...
      ImmutableList.Builder<Function<SpriteOpener, SpriteContents>> builder = ImmutableList.builder();
