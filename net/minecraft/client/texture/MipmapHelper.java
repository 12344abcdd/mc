...
public class MipmapHelper {
   ...
   private static int blend(int one, int two, int three, int four, boolean checkAlpha) {
      if (checkAlpha) {
         ...
         h /= 4.0F;
         i /= 4.0F;
         int j = (int)(Math.pow((double)f, 0.45454545454545453) * (double)255.0F);
         int k = (int)(Math.pow((double)g, 0.45454545454545453) * (double)255.0F);
         int l = (int)(Math.pow((double)h, 0.45454545454545453) * (double)255.0F);
         int m = (int)(Math.pow((double)i, 0.45454545454545453) * (double)255.0F);
         if (j < 96) {
            j = 0;
         }
   ...
   private static int getColorComponent(int one, int two, int three, int four, int bits) {
      ...
      float j = (float)((double)((float)Math.pow((double)(f + g + h + i) * (double)0.25F, 0.45454545454545453)));
      return (int)((double)j * (double)255.0F);
   }
