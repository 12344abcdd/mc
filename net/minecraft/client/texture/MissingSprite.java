...
public final class MissingSprite {
   ...
   static {
      METADATA = (new ResourceMetadata.Builder()).add(AnimationResourceMetadata.READER, new AnimationResourceMetadata(ImmutableList.of(new AnimationFrameResourceMetadata(0, -1)), 16, 16, 1, false)).build();
   }
}
