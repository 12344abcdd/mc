...
public class BubbleColumnSoundPlayer implements ClientPlayerTickable {
   ...
   public void tick() {
      ...
      BlockState blockState = (BlockState)world.getStatesInBoxIfLoaded(this.player.getBoundingBox().expand((double)0.0F, (double)-0.4F, (double)0.0F).contract(1.0E-6)).filter((state) -> state.isOf(Blocks.BUBBLE_COLUMN)).findFirst().orElse((Object)null);
      if (blockState != null) {
