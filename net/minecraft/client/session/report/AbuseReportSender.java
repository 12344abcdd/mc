   ...
   public static record Impl(ReporterEnvironment environment, UserApiService userApiService) implements AbuseReportSender {
      ...
      public CompletableFuture send(UUID id, AbuseReportType type, com.mojang.authlib.minecraft.report.AbuseReport report) {
         return CompletableFuture.supplyAsync(() -> {
            ...
            try {
               ...
               throw new CompletionException(new AbuseReportException(text, minecraftClientHttpException));
            } catch (MinecraftClientException minecraftClientException) {
               Text text = this.getErrorText(minecraftClientException);
               throw new CompletionException(new AbuseReportException(text, minecraftClientException));
            }
      ...
      private Text getErrorText(MinecraftClientException exception) {
         ...
         switch (exception.getType()) {
            case SERVICE_UNAVAILABLE -> var10000 = SERVICE_UNAVAILABLE_ERROR_TEXT;
