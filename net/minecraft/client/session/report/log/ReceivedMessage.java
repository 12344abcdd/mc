...
public interface ReceivedMessage extends ChatLogEntry {
   ...
   public static record ChatMessage(GameProfile profile, SignedMessage message, MessageTrustStatus trustStatus) implements ReceivedMessage {
      public static final MapCodec CHAT_MESSAGE_CODEC = RecordCodecBuilder.mapCodec((instance) -> instance.group(Codecs.GAME_PROFILE_WITH_PROPERTIES.fieldOf("profile").forGetter(ChatMessage::profile), SignedMessage.CODEC.forGetter(ChatMessage::message), MessageTrustStatus.CODEC.optionalFieldOf("trust_level", MessageTrustStatus.SECURE).forGetter(ChatMessage::trustStatus)).apply(instance, ChatMessage::new));
   ...
   public static record GameMessage(Text message, Instant timestamp) implements ReceivedMessage {
      public static final MapCodec GAME_MESSAGE_CODEC = RecordCodecBuilder.mapCodec((instance) -> instance.group(TextCodecs.CODEC.fieldOf("message").forGetter(GameMessage::message), Codecs.INSTANT.fieldOf("time_stamp").forGetter(GameMessage::timestamp)).apply(instance, GameMessage::new));
