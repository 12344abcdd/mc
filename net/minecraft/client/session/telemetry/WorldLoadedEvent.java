...
public class WorldLoadedEvent {
   ...
   public void setGameMode(GameMode gameMode, boolean hardcore) {
      ...
      switch (gameMode) {
         case SURVIVAL -> var10001 = hardcore ? TelemetryEventProperty.GameMode.HARDCORE : TelemetryEventProperty.GameMode.SURVIVAL;
         case CREATIVE -> var10001 = TelemetryEventProperty.GameMode.CREATIVE;
         case ADVENTURE -> var10001 = TelemetryEventProperty.GameMode.ADVENTURE;
         case SPECTATOR -> var10001 = TelemetryEventProperty.GameMode.SPECTATOR;
