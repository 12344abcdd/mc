...
public class TexturedRenderLayers {
   ...
   public static SpriteIdentifier getBannerPatternTextureId(RegistryEntry pattern) {
      return (SpriteIdentifier)BANNER_PATTERN_TEXTURES.computeIfAbsent(((BannerPattern)pattern.value()).assetId(), (id) -> {
   ...
   public static SpriteIdentifier getShieldPatternTextureId(RegistryEntry pattern) {
      return (SpriteIdentifier)SHIELD_PATTERN_TEXTURES.computeIfAbsent(((BannerPattern)pattern.value()).assetId(), (id) -> {
   ...
   static {
      ...
      SHULKER_TEXTURE_ID = new SpriteIdentifier(SHULKER_BOXES_ATLAS_TEXTURE, Identifier.ofVanilla("entity/shulker/shulker"));
      COLORED_SHULKER_BOXES_TEXTURES = (List)Stream.of("white", "orange", "magenta", "light_blue", "yellow", "lime", "pink", "gray", "light_gray", "cyan", "purple", "blue", "brown", "green", "red", "black").map((colorName) -> new SpriteIdentifier(SHULKER_BOXES_ATLAS_TEXTURE, Identifier.ofVanilla("entity/shulker/shulker_" + colorName))).collect(ImmutableList.toImmutableList());
      ...
      BANNER_BASE = new SpriteIdentifier(BANNER_PATTERNS_ATLAS_TEXTURE, Identifier.ofVanilla("entity/banner/base"));
      SHIELD_BASE = new SpriteIdentifier(SHIELD_PATTERNS_ATLAS_TEXTURE, Identifier.ofVanilla("entity/shield/base"));
      BANNER_PATTERN_TEXTURES = new HashMap();
      SHIELD_PATTERN_TEXTURES = new HashMap();
      DECORATED_POT_PATTERN_TEXTURES = (Map)Registries.DECORATED_POT_PATTERN.streamEntries().collect(Collectors.toMap(RegistryEntry.Reference::registryKey, (reference) -> createDecoratedPotPatternTextureId(((DecoratedPotPattern)reference.value()).assetId())));
      DECORATED_POT_BASE = createDecoratedPotPatternTextureId(Identifier.ofVanilla("decorated_pot_base"));
      DECORATED_POT_SIDE = createDecoratedPotPatternTextureId(Identifier.ofVanilla("decorated_pot_side"));
      BED_TEXTURES = (SpriteIdentifier[])Arrays.stream(DyeColor.values()).sorted(Comparator.comparingInt(DyeColor::getId)).map((color) -> new SpriteIdentifier(BEDS_ATLAS_TEXTURE, Identifier.ofVanilla("entity/bed/" + color.getName()))).toArray((i) -> new SpriteIdentifier[i]);
