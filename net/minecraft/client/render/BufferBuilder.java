   ...
   private void endVertex() {
      if (this.vertexCount != 0) {
         if (this.currentMask != 0) {
            Stream var10000 = VertexFormatElement.streamFromMask(this.currentMask);
            VertexFormat var10001 = this.format;
            Objects.requireNonNull(var10001);
            String string = (String)var10000.map(var10001::getName).collect(Collectors.joining(", "));
