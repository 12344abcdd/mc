      ...
      if (Client.hasDisplayItem(vaultBlockEntity.getSharedData())) {
         ...
         if (world != null) {
            ...
            if (!itemStack.isEmpty()) {
               ...
               renderDisplayItem(f, world, matrixStack, vertexConsumerProvider, i, itemStack, this.itemRenderer, vaultClientData.getPreviousDisplayRotation(), vaultClientData.getDisplayRotation(), this.random);
            }
         }
      }
   }
