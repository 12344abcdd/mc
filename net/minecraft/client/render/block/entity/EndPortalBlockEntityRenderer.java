...
public class EndPortalBlockEntityRenderer implements BlockEntityRenderer {
   ...
   public void render(EndPortalBlockEntity endPortalBlockEntity, float f, MatrixStack matrixStack, VertexConsumerProvider vertexConsumerProvider, int i, int j) {
