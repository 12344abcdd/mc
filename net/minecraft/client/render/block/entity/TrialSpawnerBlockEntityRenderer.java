...
public class TrialSpawnerBlockEntityRenderer implements BlockEntityRenderer {
   ...
   public void render(TrialSpawnerBlockEntity trialSpawnerBlockEntity, float f, MatrixStack matrixStack, VertexConsumerProvider vertexConsumerProvider, int i, int j) {
