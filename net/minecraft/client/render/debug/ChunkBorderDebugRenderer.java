...
public class ChunkBorderDebugRenderer implements DebugRenderer.Renderer {
   ...
   public void render(MatrixStack matrices, VertexConsumerProvider vertexConsumers, double cameraX, double cameraY, double cameraZ) {
      ...
      VertexConsumer vertexConsumer = vertexConsumers.getBuffer(RenderLayer.getDebugLineStrip((double)1.0F));
      ...
      vertexConsumer = vertexConsumers.getBuffer(RenderLayer.getDebugLineStrip((double)2.0F));
