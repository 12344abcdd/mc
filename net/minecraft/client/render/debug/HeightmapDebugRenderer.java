...
public class HeightmapDebugRenderer implements DebugRenderer.Renderer {
   ...
   public void render(MatrixStack matrices, VertexConsumerProvider vertexConsumers, double cameraX, double cameraY, double cameraZ) {
      ...
      BlockPos blockPos = BlockPos.ofFloored(cameraX, (double)0.0F, cameraZ);
            ...
            for(Map.Entry entry : chunk.getHeightmaps()) {
               ...
               for(int k = 0; k < 16; ++k) {
                  for(int l = 0; l < 16; ++l) {
                     ...
                     WorldRenderer.renderFilledBox(matrices, vertexConsumer, (double)((float)m + 0.25F) - cameraX, (double)f, (double)((float)n + 0.25F) - cameraZ, (double)((float)m + 0.75F) - cameraX, (double)(f + 0.09375F), (double)((float)n + 0.75F) - cameraZ, vector3f.x(), vector3f.y(), vector3f.z(), 1.0F);
                  }
               }
            }
         }
