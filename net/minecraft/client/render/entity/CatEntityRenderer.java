...
public class CatEntityRenderer extends MobEntityRenderer {
   ...
   protected void setupTransforms(CatEntity catEntity, MatrixStack matrixStack, float f, float g, float h, float i) {
      ...
      if (j > 0.0F) {
         ...
         for(PlayerEntity playerEntity : catEntity.getWorld().getNonSpectatingEntities(PlayerEntity.class, (new Box(blockPos)).expand((double)2.0F, (double)2.0F, (double)2.0F))) {
