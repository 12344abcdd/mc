...
public class TurtleEntityModel extends QuadrupedEntityModel {
   ...
   public static TexturedModelData getTexturedModelData() {
      ...
      modelPartData.addChild("body", ModelPartBuilder.create().uv(7, 37).cuboid("shell", -9.5F, 3.0F, -10.0F, 19.0F, 20.0F, 6.0F).uv(31, 1).cuboid("belly", -5.5F, 3.0F, -13.0F, 11.0F, 18.0F, 3.0F), ModelTransform.of(0.0F, 11.0F, -10.0F, ((float)Math.PI / 2F), 0.0F, 0.0F));
      modelPartData.addChild("egg_belly", ModelPartBuilder.create().uv(70, 33).cuboid(-4.5F, 3.0F, -14.0F, 9.0F, 18.0F, 1.0F), ModelTransform.of(0.0F, 11.0F, -10.0F, ((float)Math.PI / 2F), 0.0F, 0.0F));
      int i = 1;
   ...
   public void setAngles(TurtleEntity turtleEntity, float f, float g, float h, float i, float j) {
