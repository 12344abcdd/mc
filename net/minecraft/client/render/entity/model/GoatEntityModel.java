...
public class GoatEntityModel extends QuadrupedEntityModel {
   ...
   public void setAngles(GoatEntity goatEntity, float f, float g, float h, float i, float j) {
      this.head.getChild("left_horn").visible = goatEntity.hasLeftHorn();
      this.head.getChild("right_horn").visible = goatEntity.hasRightHorn();
