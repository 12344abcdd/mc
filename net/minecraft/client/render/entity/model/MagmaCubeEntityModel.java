...
public class MagmaCubeEntityModel extends SinglePartEntityModel {
   ...
   public void setAngles(SlimeEntity slimeEntity, float f, float g, float h, float i, float j) {
   }

   public void animateModel(SlimeEntity slimeEntity, float f, float g, float h) {
