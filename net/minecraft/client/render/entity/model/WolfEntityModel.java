...
public class WolfEntityModel extends TintableAnimalModel {
   ...
   public static ModelData getTexturedModelData(Dilation dilation) {
      ...
      modelPartData.addChild("body", ModelPartBuilder.create().uv(18, 14).cuboid(-3.0F, -2.0F, -3.0F, 6.0F, 9.0F, 6.0F, dilation), ModelTransform.of(0.0F, 14.0F, 2.0F, ((float)Math.PI / 2F), 0.0F, 0.0F));
      ...
      ModelPartData modelPartData3 = modelPartData.addChild("tail", ModelPartBuilder.create(), ModelTransform.of(-1.0F, 12.0F, 8.0F, ((float)Math.PI / 5F), 0.0F, 0.0F));
   ...
   public void animateModel(WolfEntity wolfEntity, float f, float g, float h) {
   ...
   public void setAngles(WolfEntity wolfEntity, float f, float g, float h, float i, float j) {
