...
public class CamelEntityModel extends SinglePartEntityModel {
   ...
   public static TexturedModelData getTexturedModelData() {
      ...
      modelPartData3.addChild("left_ear", ModelPartBuilder.create().uv(45, 0).cuboid(-0.5F, 0.5F, -1.0F, 3.0F, 1.0F, 2.0F), ModelTransform.pivot(2.5F, -21.0F, -9.5F));
      modelPartData3.addChild("right_ear", ModelPartBuilder.create().uv(67, 0).cuboid(-2.5F, 0.5F, -1.0F, 3.0F, 1.0F, 2.0F), ModelTransform.pivot(-2.5F, -21.0F, -9.5F));
   ...
   public void setAngles(CamelEntity camelEntity, float f, float g, float h, float i, float j) {
