...
public class PandaEntityModel extends QuadrupedEntityModel {
   ...
   public static TexturedModelData getTexturedModelData() {
      ...
      modelPartData.addChild("body", ModelPartBuilder.create().uv(0, 25).cuboid(-9.5F, -13.0F, -6.5F, 19.0F, 26.0F, 13.0F), ModelTransform.of(0.0F, 10.0F, 0.0F, ((float)Math.PI / 2F), 0.0F, 0.0F));
      int i = 9;
      int j = 6;
   ...
   public void animateModel(PandaEntity pandaEntity, float f, float g, float h) {
   ...
   public void setAngles(PandaEntity pandaEntity, float f, float g, float h, float i, float j) {
      ...
      if (this.sittingAnimationProgress > 0.0F) {
         ...
         this.head.pitch = ModelUtil.interpolateAngle(this.head.pitch, ((float)Math.PI / 2F), this.sittingAnimationProgress);
      ...
      if (this.lieOnBackAnimationProgress > 0.0F) {
         ...
         this.head.pitch = ModelUtil.interpolateAngle(this.head.pitch, ((float)Math.PI / 2F), this.lieOnBackAnimationProgress);
      }
