...
public class ShulkerEntityModel extends CompositeEntityModel {
   ...
   public void setAngles(ShulkerEntity shulkerEntity, float f, float g, float h, float i, float j) {
      ...
      this.head.yaw = (shulkerEntity.headYaw - 180.0F - shulkerEntity.bodyYaw) * ((float)Math.PI / 180F);
   }
