...
public class ArmorStandEntityModel extends ArmorStandArmorEntityModel {
   ...
   public void animateModel(ArmorStandEntity armorStandEntity, float f, float g, float h) {
      ...
      this.basePlate.yaw = ((float)Math.PI / 180F) * -MathHelper.lerpAngleDegrees(h, armorStandEntity.prevYaw, armorStandEntity.getYaw());
   ...
   public void setAngles(ArmorStandEntity armorStandEntity, float f, float g, float h, float i, float j) {
      ...
      this.rightBodyStick.pitch = ((float)Math.PI / 180F) * armorStandEntity.getBodyRotation().getPitch();
      this.rightBodyStick.yaw = ((float)Math.PI / 180F) * armorStandEntity.getBodyRotation().getYaw();
      this.rightBodyStick.roll = ((float)Math.PI / 180F) * armorStandEntity.getBodyRotation().getRoll();
      this.leftBodyStick.pitch = ((float)Math.PI / 180F) * armorStandEntity.getBodyRotation().getPitch();
      this.leftBodyStick.yaw = ((float)Math.PI / 180F) * armorStandEntity.getBodyRotation().getYaw();
      this.leftBodyStick.roll = ((float)Math.PI / 180F) * armorStandEntity.getBodyRotation().getRoll();
      this.shoulderStick.pitch = ((float)Math.PI / 180F) * armorStandEntity.getBodyRotation().getPitch();
      this.shoulderStick.yaw = ((float)Math.PI / 180F) * armorStandEntity.getBodyRotation().getYaw();
      this.shoulderStick.roll = ((float)Math.PI / 180F) * armorStandEntity.getBodyRotation().getRoll();
   }
