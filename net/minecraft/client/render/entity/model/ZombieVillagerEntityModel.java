...
public class ZombieVillagerEntityModel extends BipedEntityModel implements ModelWithHat {
   ...
   public static TexturedModelData getTexturedModelData() {
      ...
      modelPartData2.addChild("hat_rim", ModelPartBuilder.create().uv(30, 47).cuboid(-8.0F, -8.0F, -6.0F, 16.0F, 16.0F, 1.0F), ModelTransform.rotation((-(float)Math.PI / 2F), 0.0F, 0.0F));
   ...
   public void setAngles(ZombieEntity zombieEntity, float f, float g, float h, float i, float j) {
