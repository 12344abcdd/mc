...
public class ArmadilloEntityModel extends SinglePartEntityModelWithChildTransform {
   ...
   public static TexturedModelData getTexturedModelData() {
      ...
      ModelPartData modelPartData2 = modelPartData.addChild("body", ModelPartBuilder.create().uv(0, 20).cuboid(-4.0F, -7.0F, -10.0F, 8.0F, 8.0F, 12.0F, new Dilation(0.3F)).uv(0, 40).cuboid(-4.0F, -7.0F, -10.0F, 8.0F, 8.0F, 12.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, 21.0F, 4.0F));
      ...
      modelPartData.addChild("right_hind_leg", ModelPartBuilder.create().uv(51, 31).cuboid(-1.0F, 0.0F, -1.0F, 2.0F, 3.0F, 2.0F, new Dilation(0.0F)), ModelTransform.pivot(-2.0F, 21.0F, 4.0F));
      modelPartData.addChild("left_hind_leg", ModelPartBuilder.create().uv(42, 31).cuboid(-1.0F, 0.0F, -1.0F, 2.0F, 3.0F, 2.0F, new Dilation(0.0F)), ModelTransform.pivot(2.0F, 21.0F, 4.0F));
      modelPartData.addChild("right_front_leg", ModelPartBuilder.create().uv(51, 43).cuboid(-1.0F, 0.0F, -1.0F, 2.0F, 3.0F, 2.0F, new Dilation(0.0F)), ModelTransform.pivot(-2.0F, 21.0F, -4.0F));
      modelPartData.addChild("left_front_leg", ModelPartBuilder.create().uv(42, 43).cuboid(-1.0F, 0.0F, -1.0F, 2.0F, 3.0F, 2.0F, new Dilation(0.0F)), ModelTransform.pivot(2.0F, 21.0F, -4.0F));
      modelPartData.addChild("cube", ModelPartBuilder.create().uv(0, 0).cuboid(-5.0F, -10.0F, -6.0F, 10.0F, 10.0F, 10.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, 24.0F, 0.0F));
   ...
   public void setAngles(ArmadilloEntity armadilloEntity, float f, float g, float h, float i, float j) {
      ...
      if (armadilloEntity.isRolledUp()) {
         ...
         this.head.pitch = MathHelper.clamp(j, -22.5F, 25.0F) * ((float)Math.PI / 180F);
         this.head.yaw = MathHelper.clamp(i, -32.5F, 32.5F) * ((float)Math.PI / 180F);
      }
