...
public class DolphinEntityModel extends SinglePartEntityModel {
   ...
   public static TexturedModelData getTexturedModelData() {
      ...
      modelPartData2.addChild("back_fin", ModelPartBuilder.create().uv(51, 0).cuboid(-0.5F, 0.0F, 8.0F, 1.0F, 4.0F, 5.0F), ModelTransform.rotation(((float)Math.PI / 3F), 0.0F, 0.0F));
      modelPartData2.addChild("left_fin", ModelPartBuilder.create().uv(48, 20).mirrored().cuboid(-0.5F, -4.0F, 0.0F, 1.0F, 4.0F, 7.0F), ModelTransform.of(2.0F, -2.0F, 4.0F, ((float)Math.PI / 3F), 0.0F, 2.0943952F));
      modelPartData2.addChild("right_fin", ModelPartBuilder.create().uv(48, 20).cuboid(-0.5F, -4.0F, 0.0F, 1.0F, 4.0F, 7.0F), ModelTransform.of(-2.0F, -2.0F, 4.0F, ((float)Math.PI / 3F), 0.0F, -2.0943952F));
