...
public class WindChargeEntityModel extends SinglePartEntityModel {
   ...
   public void setAngles(AbstractWindChargeEntity abstractWindChargeEntity, float f, float g, float h, float i, float j) {
      this.windCharge.yaw = -h * 16.0F * ((float)Math.PI / 180F);
      this.wind.yaw = h * 16.0F * ((float)Math.PI / 180F);
   }
