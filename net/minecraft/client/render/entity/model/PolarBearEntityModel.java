...
public class PolarBearEntityModel extends QuadrupedEntityModel {
   ...
   public static TexturedModelData getTexturedModelData() {
      ...
      modelPartData.addChild("body", ModelPartBuilder.create().uv(0, 19).cuboid(-5.0F, -13.0F, -7.0F, 14.0F, 14.0F, 11.0F).uv(39, 0).cuboid(-4.0F, -25.0F, -7.0F, 12.0F, 12.0F, 10.0F), ModelTransform.of(-2.0F, 9.0F, 12.0F, ((float)Math.PI / 2F), 0.0F, 0.0F));
      int i = 10;
   ...
   public void setAngles(PolarBearEntity polarBearEntity, float f, float g, float h, float i, float j) {
