...
public class QuadrupedEntityModel extends AnimalModel {
   ...
   public static ModelData getModelData(int stanceWidth, Dilation dilation) {
      ...
      modelPartData.addChild("head", ModelPartBuilder.create().uv(0, 0).cuboid(-4.0F, -4.0F, -8.0F, 8.0F, 8.0F, 8.0F, dilation), ModelTransform.pivot(0.0F, (float)(18 - stanceWidth), -6.0F));
      modelPartData.addChild("body", ModelPartBuilder.create().uv(28, 8).cuboid(-5.0F, -10.0F, -7.0F, 10.0F, 16.0F, 8.0F, dilation), ModelTransform.of(0.0F, (float)(17 - stanceWidth), 2.0F, ((float)Math.PI / 2F), 0.0F, 0.0F));
