...
public class LargeTropicalFishEntityModel extends TintableCompositeModel {
   ...
   public static TexturedModelData getTexturedModelData(Dilation dilation) {
      ...
      modelPartData.addChild("right_fin", ModelPartBuilder.create().uv(2, 16).cuboid(-2.0F, 0.0F, 0.0F, 2.0F, 2.0F, 0.0F, dilation), ModelTransform.of(-1.0F, 20.0F, 0.0F, 0.0F, ((float)Math.PI / 4F), 0.0F));
      modelPartData.addChild("left_fin", ModelPartBuilder.create().uv(2, 12).cuboid(0.0F, 0.0F, 0.0F, 2.0F, 2.0F, 0.0F, dilation), ModelTransform.of(1.0F, 20.0F, 0.0F, 0.0F, (-(float)Math.PI / 4F), 0.0F));
