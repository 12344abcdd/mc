...
public class PigEntityRenderer extends MobEntityRenderer {
   ...
   public PigEntityRenderer(EntityRendererFactory.Context context) {
      ...
      this.addFeature(new SaddleFeatureRenderer(this, new PigEntityModel(context.getPart(EntityModelLayers.PIG_SADDLE)), Identifier.ofVanilla("textures/entity/pig/pig_saddle.png")));
   }
