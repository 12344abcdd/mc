...
public abstract class LivingEntityRenderer extends EntityRenderer implements FeatureRendererContext {
   ...
   protected void setupTransforms(LivingEntity entity, MatrixStack matrices, float animationProgress, float bodyYaw, float tickDelta, float scale) {
