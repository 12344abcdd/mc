...
public abstract class FeatureRenderer {
   ...
   protected static void render(EntityModel contextModel, EntityModel model, Identifier texture, MatrixStack matrices, VertexConsumerProvider vertexConsumers, int light, LivingEntity entity, float limbAngle, float limbDistance, float age, float headYaw, float headPitch, float tickDelta, int i) {
   ...
   protected static void renderModel(EntityModel model, Identifier texture, MatrixStack matrices, VertexConsumerProvider vertexConsumers, int light, LivingEntity entity, int i) {
