...
public class DrownedOverlayFeatureRenderer extends FeatureRenderer {
   ...
   public void render(MatrixStack matrixStack, VertexConsumerProvider vertexConsumerProvider, int i, DrownedEntity drownedEntity, float f, float g, float h, float j, float k, float l) {
