...
public class MooshroomMushroomFeatureRenderer extends FeatureRenderer {
   ...
   public void render(MatrixStack matrixStack, VertexConsumerProvider vertexConsumerProvider, int i, MooshroomEntity mooshroomEntity, float f, float g, float h, float j, float k, float l) {
