...
public class SnowGolemPumpkinFeatureRenderer extends FeatureRenderer {
   ...
   public SnowGolemPumpkinFeatureRenderer(FeatureRendererContext context, BlockRenderManager blockRenderManager, ItemRenderer itemRenderer) {
      super(context);
      ...
      if (snowGolemEntity.hasPumpkin()) {
         ...
         if (!snowGolemEntity.isInvisible() || bl) {
            ...
            if (bl) {
               ...
               this.itemRenderer.renderItem(snowGolemEntity, itemStack, ModelTransformationMode.HEAD, false, matrixStack, vertexConsumerProvider, snowGolemEntity.getWorld(), i, LivingEntityRenderer.getOverlay(snowGolemEntity, 0.0F), snowGolemEntity.getId());
            }
