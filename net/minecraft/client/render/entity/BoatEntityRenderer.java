...
public class BoatEntityRenderer extends EntityRenderer {
   ...
   public BoatEntityRenderer(EntityRendererFactory.Context ctx, boolean chest) {
      ...
      this.texturesAndModels = (Map)Stream.of(Type.values()).collect(ImmutableMap.toImmutableMap((type) -> type, (type) -> Pair.of(getTexture(type, chest), this.createModel(ctx, type, chest))));
   }
   ...
   private static Identifier getTexture(BoatEntity.Type type, boolean chest) {
      return chest ? Identifier.ofVanilla("textures/entity/chest_boat/" + type.getName() + ".png") : Identifier.ofVanilla("textures/entity/boat/" + type.getName() + ".png");
   }
