...
public class EntityRenderers {
   ...
   static {
      PLAYER_RENDERER_FACTORIES = Map.of(SkinTextures.Model.WIDE, (EntityRendererFactory)(context) -> new PlayerEntityRenderer(context, false), SkinTextures.Model.SLIM, (EntityRendererFactory)(context) -> new PlayerEntityRenderer(context, true));
      ...
      register(EntityType.PIGLIN, (context) -> new PiglinEntityRenderer(context, EntityModelLayers.PIGLIN, EntityModelLayers.PIGLIN_INNER_ARMOR, EntityModelLayers.PIGLIN_OUTER_ARMOR, false));
      register(EntityType.PIGLIN_BRUTE, (context) -> new PiglinEntityRenderer(context, EntityModelLayers.PIGLIN_BRUTE, EntityModelLayers.PIGLIN_BRUTE_INNER_ARMOR, EntityModelLayers.PIGLIN_BRUTE_OUTER_ARMOR, false));
      ...
      register(EntityType.ZOMBIFIED_PIGLIN, (context) -> new PiglinEntityRenderer(context, EntityModelLayers.ZOMBIFIED_PIGLIN, EntityModelLayers.ZOMBIFIED_PIGLIN_INNER_ARMOR, EntityModelLayers.ZOMBIFIED_PIGLIN_OUTER_ARMOR, true));
   }
}
