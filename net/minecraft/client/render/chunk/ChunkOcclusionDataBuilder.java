...
public class ChunkOcclusionDataBuilder {
   ...
   private static final int STEP_X = (int)Math.pow((double)16.0F, (double)0.0F);
   private static final int STEP_Z = (int)Math.pow((double)16.0F, (double)1.0F);
   private static final int STEP_Y = (int)Math.pow((double)16.0F, (double)2.0F);
