...
public class SectionBuilder {
   ...
   private BufferBuilder beginBufferBuilding(Map builders, BlockBufferAllocatorStorage allocatorStorage, RenderLayer layer) {
   ...
   public static final class RenderData {
      ...
      public final Map buffers = new Reference2ObjectArrayMap();
