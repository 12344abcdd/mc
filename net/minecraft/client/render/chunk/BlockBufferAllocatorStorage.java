...
public class BlockBufferAllocatorStorage implements AutoCloseable {
   private static final List BLOCK_LAYERS = RenderLayer.getBlockLayers();
   public static final int EXPECTED_TOTAL_SIZE;
   private final Map allocators;

   public BlockBufferAllocatorStorage() {
      this.allocators = (Map)Util.make(new Reference2ObjectArrayMap(BLOCK_LAYERS.size()), (map) -> {
