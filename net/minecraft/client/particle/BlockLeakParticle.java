...
public class BlockLeakParticle extends SpriteBillboardParticle {
   ...
   public static SpriteBillboardParticle createLandingHoney(SimpleParticleType type, ClientWorld world, double x, double y, double z, double velocityX, double velocityY, double velocityZ) {
      ...
      blockLeakParticle.maxAge = (int)((double)128.0F / (Math.random() * 0.8 + 0.2));
   ...
   public static SpriteBillboardParticle createFallingNectar(SimpleParticleType type, ClientWorld world, double x, double y, double z, double velocityX, double velocityY, double velocityZ) {
      ...
      blockLeakParticle.maxAge = (int)((double)16.0F / (Math.random() * 0.8 + 0.2));
   ...
   public static SpriteBillboardParticle createLandingObsidianTear(SimpleParticleType type, ClientWorld world, double x, double y, double z, double velocityX, double velocityY, double velocityZ) {
      BlockLeakParticle blockLeakParticle = new Landing(world, x, y, z, Fluids.EMPTY);
      blockLeakParticle.obsidianTear = true;
      blockLeakParticle.maxAge = (int)((double)28.0F / (Math.random() * 0.8 + 0.2));
      blockLeakParticle.setColor(0.51171875F, 0.03125F, 0.890625F);
      return blockLeakParticle;
   }
   ...
   static class ContinuousFalling extends Falling {
      ...
      protected void updateVelocity() {
         if (this.onGround) {
            this.markDead();
            this.world.addParticle(this.nextParticle, this.x, this.y, this.z, (double)0.0F, (double)0.0F, (double)0.0F);
         }
   ...
   static class Falling extends BlockLeakParticle {
      Falling(ClientWorld clientWorld, double d, double e, double f, Fluid fluid) {
         this(clientWorld, d, e, f, fluid, (int)((double)64.0F / (Math.random() * 0.8 + 0.2)));
      }
