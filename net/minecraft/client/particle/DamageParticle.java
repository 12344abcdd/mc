...
public class DamageParticle extends SpriteBillboardParticle {
   DamageParticle(ClientWorld clientWorld, double d, double e, double f, double g, double h, double i) {
      ...
      float j = (float)(Math.random() * (double)0.3F + (double)0.6F);
      this.red = j;
      this.green = j;
      this.blue = j;
      this.scale *= 0.75F;
      this.maxAge = Math.max((int)((double)6.0F / (Math.random() * 0.8 + 0.6)), 1);
   ...
   public static class DefaultFactory implements ParticleFactory {
      ...
      public Particle createParticle(SimpleParticleType simpleParticleType, ClientWorld clientWorld, double d, double e, double f, double g, double h, double i) {
         DamageParticle damageParticle = new DamageParticle(clientWorld, d, e, f, g, h + (double)1.0F, i);
