...
public class VibrationParticle extends SpriteBillboardParticle {
   ...
   public void buildGeometry(VertexConsumer vertexConsumer, Camera camera, float tickDelta) {
      float f = MathHelper.sin(((float)this.age + tickDelta - ((float)Math.PI * 2F)) * 0.05F) * 2.0F;
      float g = MathHelper.lerp(tickDelta, this.field_28248, this.field_28250);
      float h = MathHelper.lerp(tickDelta, this.field_40508, this.field_40507) + ((float)Math.PI / 2F);
