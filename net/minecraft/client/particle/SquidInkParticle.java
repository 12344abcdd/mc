...
public class SquidInkParticle extends AnimatedParticle {
   SquidInkParticle(ClientWorld world, double x, double y, double z, double velocityX, double velocityY, double velocityZ, int color, SpriteProvider spriteProvider) {
      ...
      this.scale = 0.5F;
      this.setAlpha(1.0F);
      this.setColor((float)Argb.getRed(color), (float)Argb.getGreen(color), (float)Argb.getBlue(color));
   ...
   public static class Factory implements ParticleFactory {
      ...
      public Particle createParticle(SimpleParticleType simpleParticleType, ClientWorld clientWorld, double d, double e, double f, double g, double h, double i) {
         return new SquidInkParticle(clientWorld, d, e, f, g, h, i, Argb.getArgb(255, 255, 255, 255), this.spriteProvider);
      }
   ...
   public static class GlowSquidInkFactory implements ParticleFactory {
      ...
      public Particle createParticle(SimpleParticleType simpleParticleType, ClientWorld clientWorld, double d, double e, double f, double g, double h, double i) {
         return new SquidInkParticle(clientWorld, d, e, f, g, h, i, Argb.getArgb(255, 204, 31, 102), this.spriteProvider);
      }
