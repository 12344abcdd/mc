   ...
   private static ShaderStage loadShader(final ResourceFactory factory, ShaderStage.Type type, String name) throws IOException {
      ...
      if (shaderStage == null) {
         ...
         try {
            ...
            shaderStage2 = ShaderStage.createFromResource(type, name, inputStream, resource.getPackId(), new GlImportProcessor(string2, factory) {
               ...
               public String loadImport(boolean inline, String name) {
                  ...
                  if (!this.visitedImports.add(name)) {
                     ...
                     try {
                        ...
                        ShaderProgram.LOGGER.error("Could not open GLSL import {}: {}", name, iOException.getMessage());
