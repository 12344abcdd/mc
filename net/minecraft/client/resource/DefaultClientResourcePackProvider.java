...
public class DefaultClientResourcePackProvider extends VanillaResourcePackProvider {
   ...
   static {
      METADATA = new PackResourceMetadata(Text.translatable("resourcePack.vanilla.description"), SharedConstants.getGameVersion().getResourceVersion(ResourceType.CLIENT_RESOURCES), Optional.empty());
      ...
      REQUIRED_POSITION = new ResourcePackPosition(true, InsertionPosition.BOTTOM, false);
      OPTIONAL_POSITION = new ResourcePackPosition(false, InsertionPosition.TOP, false);
