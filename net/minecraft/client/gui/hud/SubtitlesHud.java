      ...
      if (this.enabled) {
         ...
         if (!this.audibleEntries.isEmpty()) {
            ...
            while(iterator.hasNext()) {
               ...
               subtitleEntry2.removeExpired((double)3000.0F * d);
            ...
            for(SubtitleEntry subtitleEntry2 : this.audibleEntries) {
               ...
               if (soundEntry != null) {
                  ...
                  int p = MathHelper.floor(MathHelper.clampedLerp(255.0F, 75.0F, (float)(Util.getMeasuringTimeMs() - soundEntry.time) / (float)((double)3000.0F * d)));
                  int q = p << 16 | p << 8 | p;
   ...
   static class SubtitleEntry {
      ...
      public SoundEntry getNearestSound(Vec3d pos) {
         if (this.sounds.isEmpty()) {
            ...
            return this.sounds.size() == 1 ? (SoundEntry)this.sounds.getFirst() : (SoundEntry)this.sounds.stream().min(Comparator.comparingDouble((soundPos) -> soundPos.location().distanceTo(pos))).orElse((Object)null);
         }
      }
