   ...
   private void renderSpectatorCommand(DrawContext context, int slot, int x, float y, float height, SpectatorMenuCommand command) {
      if (command != SpectatorMenu.BLANK_COMMAND) {
         ...
         if (i > 3 && command.isEnabled()) {
            ...
            context.drawTextWithShadow(this.client.textRenderer, text, x + 19 - 2 - this.client.textRenderer.getWidth((StringVisitable)text), (int)y + 6 + 3, 16777215 + (i << 24));
         }
      }
   ...
   public void render(DrawContext context) {
      ...
      if (i > 3 && this.spectatorMenu != null) {
         ...
         if (text != null) {
            ...
            context.drawTextWithBackground(this.client.textRenderer, text, k, l, j, Argb.withAlpha(i, -1));
         }
      }
