...
public class SplashOverlay extends Overlay {
   ...
   private static final int MOJANG_RED = Argb.getArgb(255, 239, 50, 61);
   private static final int MONOCHROME_BLACK = Argb.getArgb(255, 0, 0, 0);
   ...
   public void render(DrawContext context, int mouseX, int mouseY, float delta) {
      ...
      if (f >= 1.0F) {
         ...
         int k = MathHelper.ceil(MathHelper.clamp((double)g, 0.15, (double)1.0F) * (double)255.0F);
         context.fill(RenderLayer.getGuiOverlay(), 0, 0, i, j, withAlpha(BRAND_ARGB.getAsInt(), k));
      ...
      int k = (int)((double)context.getScaledWindowWidth() * (double)0.5F);
      int p = (int)((double)context.getScaledWindowHeight() * (double)0.5F);
      double d = Math.min((double)context.getScaledWindowWidth() * (double)0.75F, (double)context.getScaledWindowHeight()) * (double)0.25F;
      int q = (int)(d * (double)0.5F);
      double e = d * (double)4.0F;
      int r = (int)(e * (double)0.5F);
   ...
   private void renderProgressBar(DrawContext drawContext, int minX, int minY, int maxX, int maxY, float opacity) {
      ...
      int k = Argb.getArgb(j, 255, 255, 255);
