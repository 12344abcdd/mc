...
public class SocialInteractionsScreen extends Screen {
   ...
   protected void init() {
      ...
      this.allTabButton = (ButtonWidget)this.addDrawableChild(ButtonWidget.builder(ALL_TAB_TITLE, (button) -> this.setCurrentTab(SocialInteractionsScreen.Tab.ALL)).dimensions(j, 45, i, 20).build());
      this.hiddenTabButton = (ButtonWidget)this.addDrawableChild(ButtonWidget.builder(HIDDEN_TAB_TITLE, (button) -> this.setCurrentTab(SocialInteractionsScreen.Tab.HIDDEN)).dimensions((j + k - i) / 2 + 1, 45, i, 20).build());
      this.blockedTabButton = (ButtonWidget)this.addDrawableChild(ButtonWidget.builder(BLOCKED_TAB_TITLE, (button) -> this.setCurrentTab(SocialInteractionsScreen.Tab.BLOCKED)).dimensions(k - i + 1, 45, i, 20).build());
