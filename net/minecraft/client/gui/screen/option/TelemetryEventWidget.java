...
public class TelemetryEventWidget extends ScrollableWidget {
   ...
   protected void renderContents(DrawContext context, int mouseX, int mouseY, float delta) {
      ...
      context.getMatrices().translate((double)j, (double)i, (double)0.0F);
   ...
   static class ContentsBuilder {
      ...
      public void appendTitle(TextRenderer textRenderer, Text title, int marginBottom) {
         this.layout.add((new MultilineTextWidget(title, textRenderer)).setMaxWidth(this.gridWidth), (Consumer)((positioner) -> positioner.marginBottom(marginBottom)));
         this.narration.append(title).append("\n");
      }

      public void appendText(TextRenderer textRenderer, Text text) {
         this.layout.add((new MultilineTextWidget(text, textRenderer)).setMaxWidth(this.gridWidth - 64).setCentered(true), (Consumer)((positioner) -> positioner.alignHorizontalCenter().marginX(32)));
