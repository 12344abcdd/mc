...
public class MouseOptionsScreen extends GameOptionsScreen {
   ...
   protected void addOptions() {
      if (InputUtil.isRawMouseMotionSupported()) {
         this.body.addAll((SimpleOption[])Stream.concat(Arrays.stream(getOptions(this.gameOptions)), Stream.of(this.gameOptions.getRawMouseInput())).toArray((i) -> new SimpleOption[i]));
      } else {
