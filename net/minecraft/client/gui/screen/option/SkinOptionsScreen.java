...
public class SkinOptionsScreen extends GameOptionsScreen {
   ...
   protected void addOptions() {
      ...
      for(PlayerModelPart playerModelPart : PlayerModelPart.values()) {
         list.add(CyclingButtonWidget.onOffBuilder(this.gameOptions.isPlayerModelPartEnabled(playerModelPart)).build(playerModelPart.getOptionName(), (cyclingButtonWidget, boolean_) -> this.gameOptions.togglePlayerModelPart(playerModelPart, boolean_)));
      }
