...
public class ControlsOptionsScreen extends GameOptionsScreen {
   ...
   protected void addOptions() {
      this.body.addWidgetEntry(ButtonWidget.builder(Text.translatable("options.mouse_settings"), (buttonWidget) -> this.client.setScreen(new MouseOptionsScreen(this, this.gameOptions))).build(), ButtonWidget.builder(Text.translatable("controls.keybinds"), (buttonWidget) -> this.client.setScreen(new KeybindsScreen(this, this.gameOptions))).build());
