...
public class ReconfiguringScreen extends Screen {
   ...
   protected void init() {
      ...
      this.disconnectButton = (ButtonWidget)this.layout.add(ButtonWidget.builder(ScreenTexts.DISCONNECT, (button) -> this.connection.disconnect(ConnectScreen.ABORTED_TEXT)).build());
