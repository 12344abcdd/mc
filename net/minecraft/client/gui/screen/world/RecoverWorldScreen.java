...
public class RecoverWorldScreen extends Screen {
   ...
   public RecoverWorldScreen(MinecraftClient client, BooleanConsumer callback, LevelStorage.Session session) {
      ...
      ((ButtonWidget)directionalLayoutWidget.add(ButtonWidget.builder(RESTORE_TEXT, (buttonWidget) -> this.tryRestore(client)).size(120, 20).tooltip(bl ? null : Tooltip.of(NO_FALLBACK_TEXT)).build())).active = bl;
