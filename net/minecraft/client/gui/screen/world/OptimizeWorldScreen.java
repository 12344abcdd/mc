...
public class OptimizeWorldScreen extends Screen {
   ...
   public void render(DrawContext context, int mouseX, int mouseY, float delta) {
      ...
      context.drawCenteredTextWithShadow(var10001, var10002, var10003, k - 9 - 2, 10526880);
      if (this.updater.getTotalChunkCount() > 0) {
         context.fill(i - 1, k - 1, j + 1, l + 1, -16777216);
         context.drawTextWithShadow(this.textRenderer, (Text)Text.translatable("optimizeWorld.info.converted", new Object[]{this.updater.getUpgradedChunkCount()}), i, 40, 10526880);
         var10001 = this.textRenderer;
         MutableText var20 = Text.translatable("optimizeWorld.info.skipped", new Object[]{this.updater.getSkippedChunkCount()});
         Objects.requireNonNull(this.textRenderer);
         context.drawTextWithShadow(var10001, (Text)var20, i, 40 + 9 + 3, 10526880);
         var10001 = this.textRenderer;
         var20 = Text.translatable("optimizeWorld.info.total", new Object[]{this.updater.getTotalChunkCount()});
         Objects.requireNonNull(this.textRenderer);
         context.drawTextWithShadow(var10001, (Text)var20, i, 40 + (9 + 3) * 2, 10526880);
         int m = 0;
         ...
         Objects.requireNonNull(this.textRenderer);
         context.drawCenteredTextWithShadow(var10001, text, var10003, k + 2 * 9 + 2, 10526880);
         var10001 = this.textRenderer;
         var10003 = this.width / 2;
         int var10004 = k + (l - k) / 2;
         Objects.requireNonNull(this.textRenderer);
         context.drawCenteredTextWithShadow(var10001, text2, var10003, var10004 - 9 / 2, 10526880);
      }
