...
public class CustomizeFlatLevelScreen extends Screen {
   ...
   protected void init() {
      ...
      this.layers = (SuperflatLayersListWidget)this.addDrawableChild(new SuperflatLayersListWidget());
   ...
   public void render(DrawContext context, int mouseX, int mouseY, float delta) {
      ...
      context.drawTextWithShadow(this.textRenderer, (Text)this.tileText, i, 32, 16777215);
      context.drawTextWithShadow(this.textRenderer, (Text)this.heightText, i + 2 + 213 - this.textRenderer.getWidth((StringVisitable)this.heightText), 32, 16777215);
   }
   ...
   class SuperflatLayersListWidget extends AlwaysSelectedEntryListWidget {
      ...
      public void updateLayers() {
         ...
         List<SuperflatLayerEntry> list = this.children();
         if (i >= 0 && i < list.size()) {
      ...
      @Environment(EnvType.CLIENT)
      class SuperflatLayerEntry extends AlwaysSelectedEntryListWidget.Entry {
         public void render(DrawContext context, int index, int y, int x, int entryWidth, int entryHeight, int mouseX, int mouseY, boolean hovered, float tickDelta) {
            ...
            context.drawText(CustomizeFlatLevelScreen.this.textRenderer, text, x + 2 + 213 - CustomizeFlatLevelScreen.this.textRenderer.getWidth((StringVisitable)text), y + 3, 16777215, false);
         }
