...
public class SymlinkWarningScreen extends Screen {
   ...
   static {
      ...
      WORLD_MESSAGE = Text.translatable("symlink_warning.message.world", new Object[]{Text.of(Urls.MINECRAFT_SYMLINKS)});
      PACK_TITLE = Text.translatable("symlink_warning.title.pack").formatted(Formatting.BOLD);
      PACK_MESSAGE = Text.translatable("symlink_warning.message.pack", new Object[]{Text.of(Urls.MINECRAFT_SYMLINKS)});
   }
}
