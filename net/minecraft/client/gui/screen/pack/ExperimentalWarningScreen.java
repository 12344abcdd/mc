...
public class ExperimentalWarningScreen extends Screen {
   ...
   class DetailsScreen extends Screen {
      ...
      protected void init() {
         ...
         this.packListWidget = (PackListWidget)this.layout.addBody(new PackListWidget(this.client, ExperimentalWarningScreen.this.enabledProfiles));
      ...
      class PackListWidget extends AlwaysSelectedEntryListWidget {
         public PackListWidget(final MinecraftClient client, final Collection enabledProfiles) {
      ...
      @Environment(EnvType.CLIENT)
      class PackListWidgetEntry extends AlwaysSelectedEntryListWidget.Entry {
