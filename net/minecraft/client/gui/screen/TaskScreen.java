...
public class TaskScreen extends Screen {
   ...
   protected void init() {
      ...
      this.button = (ButtonWidget)this.addDrawableChild(ButtonWidget.builder(this.closeButtonText, (buttonWidget) -> this.close()).dimensions((this.width - 150) / 2, m, 150, 20).build());
   }
