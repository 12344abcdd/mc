...
public class DisconnectedScreen extends Screen {
   ...
   protected void init() {
      ...
      this.info.bugReportLink().ifPresent((uri) -> this.grid.add(ButtonWidget.builder(REPORT_TO_SERVER_TEXT, ConfirmLinkScreen.opening(this, (URI)uri, false)).width(200).build()));
