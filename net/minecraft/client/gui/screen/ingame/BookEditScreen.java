...
public class BookEditScreen extends Screen {
   ...
   public void render(DrawContext context, int mouseX, int mouseY, float delta) {
      ...
      if (this.signing) {
         ...
         context.drawText(this.textRenderer, (Text)EDIT_TITLE_TEXT, i + 36 + (114 - k) / 2, 34, 0, false);
         int l = this.textRenderer.getWidth(orderedText);
         context.drawText(this.textRenderer, (OrderedText)orderedText, i + 36 + (114 - l) / 2, 50, 0, false);
         int m = this.textRenderer.getWidth((StringVisitable)this.signedByText);
         context.drawText(this.textRenderer, (Text)this.signedByText, i + 36 + (114 - m) / 2, 60, 0, false);
         ...
         context.drawText(this.textRenderer, (Text)this.pageIndicatorText, i - n + 192 - 44, 18, 0, false);
         PageContent pageContent = this.getPageContent();
