   ...
   protected void init() {
      ...
      for(int i = 0; i <= 2; ++i) {
         ...
         for(int l = 0; l < j; ++l) {
            ...
            EffectButtonWidget effectButtonWidget = new EffectButtonWidget(this.x + 76 + l * 24 - k / 2, this.y + 22 + i * 25, registryEntry, true, i);
      ...
      for(int l = 0; l < j - 1; ++l) {
         ...
         EffectButtonWidget effectButtonWidget = new EffectButtonWidget(this.x + 167 + l * 24 - k / 2, this.y + 47, registryEntry, false, 3);
         effectButtonWidget.active = false;
         this.addButton(effectButtonWidget);
      }
