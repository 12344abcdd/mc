...
public abstract class AbstractInventoryScreen extends HandledScreen {
   ...
   public AbstractInventoryScreen(ScreenHandler screenHandler, PlayerInventory playerInventory, Text text) {
      ...
      if (!collection.isEmpty() && j >= 32) {
         ...
         if (bl) {
            ...
            if (statusEffectInstance != null) {
               List<Text> list = List.of(this.getStatusEffectDescription(statusEffectInstance), StatusEffectUtil.getDurationText(statusEffectInstance, 1.0F, this.client.world.getTickManager().getTickRate()));
