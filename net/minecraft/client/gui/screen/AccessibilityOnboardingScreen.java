...
public class AccessibilityOnboardingScreen extends Screen {
   ...
   public void init() {
      ...
      this.textWidget = (NarratedMultilineTextWidget)directionalLayoutWidget.add(new NarratedMultilineTextWidget(this.width, this.title, this.textRenderer), (Consumer)((positioner) -> positioner.margin(8)));
      ...
      directionalLayoutWidget.add(AccessibilityOnboardingButtons.createLanguageButton(150, (button) -> this.setScreen(new LanguageOptionsScreen(this, this.client.options, this.client.getLanguageManager())), false));
