...
public class TitleScreen extends Screen {
   ...
   private void initWidgetsNormal(int y, int spacingY) {
      ...
      ((ButtonWidget)this.addDrawableChild(ButtonWidget.builder(Text.translatable("menu.online"), (buttonWidget) -> this.client.setScreen(new RealmsMainScreen(this))).dimensions(this.width / 2 - 100, y + spacingY * 2, 200, 20).tooltip(tooltip).build())).active = bl;
   }
   ...
   private void initWidgetsDemo(int y, int spacingY) {
      ...
      this.addDrawableChild(ButtonWidget.builder(Text.translatable("menu.playdemo"), (button) -> {
         if (bl) {
            this.client.createIntegratedServerLoader().start((String)"Demo_World", () -> this.client.setScreen(this));
         } else {
   ...
   public void render(DrawContext context, int mouseX, int mouseY, float delta) {
      ...
      if ((i & -67108864) != 0) {
         ...
         context.drawTextWithShadow(this.textRenderer, (String)string, 2, this.height - 10, 16777215 | i);
