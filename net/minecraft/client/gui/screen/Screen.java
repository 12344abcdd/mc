...
public abstract class Screen extends AbstractParentElement implements Drawable {
   ...
   protected static final RotatingCubeMapRenderer ROTATING_PANORAMA_RENDERER;
   public static final Identifier MENU_BACKGROUND_TEXTURE;
   public static final Identifier HEADER_SEPARATOR_TEXTURE;
   public static final Identifier FOOTER_SEPARATOR_TEXTURE;
   ...
   public static final Identifier INWORLD_FOOTER_SEPARATOR_TEXTURE;
   ...
   protected void addElementNarrations(NarrationMessageBuilder builder) {
      ...
      if (selectedElementNarrationData != null) {
         ...
         if (list.size() > 1) {
            builder.put(NarrationPart.POSITION, (Text)Text.translatable("narrator.position.screen", new Object[]{selectedElementNarrationData.index + 1, list.size()}));
   ...
   @Environment(EnvType.CLIENT)
   static record PositionedTooltip(List tooltip, TooltipPositioner positioner) {
   }
