...
public abstract class WarningScreen extends Screen {
   ...
   protected void init() {
      ...
      this.textWidget = (NarratedMultilineTextWidget)directionalLayoutWidget.add(new NarratedMultilineTextWidget(this.width - 100, this.messageText, this.textRenderer, 12), (Consumer)((positioner) -> positioner.margin(12)));
