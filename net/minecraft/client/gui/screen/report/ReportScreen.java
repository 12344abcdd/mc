...
public abstract class ReportScreen extends Screen {
   ...
   protected void addAttestationCheckboxAndSendButton() {
      ...
      this.sendButton = (ButtonWidget)directionalLayoutWidget.add(ButtonWidget.builder(SEND_TEXT, (button) -> this.trySend()).width(120).build());
   }
   ...
   private void onSent() {
      this.resetDraft();
      this.client.setScreen(TaskScreen.createResultScreen(SENT_TITLE_TEXT, REPORT_SENT_MESSAGE_TEXT, ScreenTexts.DONE, () -> this.client.setScreen((Screen)null)));
   }
