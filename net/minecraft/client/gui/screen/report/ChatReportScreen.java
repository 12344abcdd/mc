...
public class ChatReportScreen extends ReportScreen {
   ...
   protected void addContent() {
      this.selectChatButton = (ButtonWidget)this.layout.add(ButtonWidget.builder(SELECT_CHAT_TEXT, (button) -> this.client.setScreen(new ChatSelectionScreen(this, this.context, (ChatAbuseReport.Builder)this.reportBuilder, (updatedReportBuilder) -> {
