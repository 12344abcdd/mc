...
public class SkinReportScreen extends ReportScreen {
   ...
   protected void addContent() {
      ...
      directionalLayoutWidget.add(new PlayerSkinWidget(85, 120, this.client.getEntityModelLoader(), ((SkinAbuseReport)((SkinAbuseReport.Builder)this.reportBuilder).getReport()).getSkinSupplier()));
