...
public class AbuseReportTypeScreen extends Screen {
   ...
   protected void init() {
      ...
      ButtonWidget buttonWidget = (ButtonWidget)this.layout.add(ButtonWidget.builder(CHAT_TYPE_TEXT, (button) -> this.client.setScreen(new ChatReportScreen(this.parent, this.context, this.selectedPlayer.getUuid()))).build());
      if (!this.selectedPlayer.isReportable()) {
         ...
         buttonWidget.active = false;
         buttonWidget.setTooltip(Tooltip.of(Text.translatable("gui.socialInteractions.tooltip.report.no_messages", new Object[]{this.selectedPlayer.getName()})));
      }
