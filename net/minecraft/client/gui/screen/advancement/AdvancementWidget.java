...
public class AdvancementWidget {
   ...
   public AdvancementWidget(AdvancementTab tab, MinecraftClient client, PlacedAdvancement advancement, AdvancementDisplay display) {
      ...
      this.description = Language.getInstance().reorder(this.wrapDescription(Texts.setStyleIfAbsent(display.getDescription().copy(), Style.EMPTY.withColor(display.getFrame().getTitleFormat())), j));
   ...
   private static float getMaxWidth(TextHandler textHandler, List lines) {
      ...
      return (float)var10000.mapToDouble(textHandler::getWidth).max().orElse((double)0.0F);
   }
   ...
   public void drawTooltip(DrawContext context, int originX, int originY, float alpha, int x, int y) {
      ...
      if (bl) {
         context.drawTextWithShadow(this.client.textRenderer, (OrderedText)this.title, m + 5, originY + this.y + 9, -1);
         if (text != null) {
            context.drawTextWithShadow(this.client.textRenderer, (Text)text, originX + this.x - i, originY + this.y + 9, -1);
         }
      } else {
         context.drawTextWithShadow(this.client.textRenderer, (OrderedText)this.title, originX + this.x + 32, originY + this.y + 9, -1);
         if (text != null) {
            context.drawTextWithShadow(this.client.textRenderer, (Text)text, originX + this.x + this.width - i - 5, originY + this.y + 9, -1);
         }
      }

      if (bl2) {
         for(int o = 0; o < this.description.size(); ++o) {
            TextRenderer var22 = this.client.textRenderer;
            OrderedText var24 = (OrderedText)this.description.get(o);
            int var10003 = m + 5;
            int var10004 = l + 26 - n + 7;
            Objects.requireNonNull(this.client.textRenderer);
            context.drawText(var22, var24, var10003, var10004 + o * 9, -5592406, false);
         }
      } else {
         for(int o = 0; o < this.description.size(); ++o) {
            TextRenderer var23 = this.client.textRenderer;
            OrderedText var25 = (OrderedText)this.description.get(o);
            int var26 = m + 5;
            int var27 = originY + this.y + 9 + 17;
            Objects.requireNonNull(this.client.textRenderer);
            context.drawText(var23, var25, var26, var27 + o * 9, -5592406, false);
         }
      }
