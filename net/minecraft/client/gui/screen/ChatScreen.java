...
public class ChatScreen extends Screen {
   public static final double SHIFT_SCROLL_AMOUNT = (double)7.0F;
   ...
   public boolean mouseScrolled(double mouseX, double mouseY, double horizontalAmount, double verticalAmount) {
      verticalAmount = MathHelper.clamp(verticalAmount, (double)-1.0F, (double)1.0F);
      if (this.chatInputSuggestor.mouseScrolled(verticalAmount)) {
         return true;
      } else {
         if (!hasShiftDown()) {
            verticalAmount *= (double)7.0F;
         }
   ...
   protected void addScreenNarrations(NarrationMessageBuilder messageBuilder) {
      ...
      String string = this.chatField.getText();
      if (!string.isEmpty()) {
         messageBuilder.nextMessage().put(NarrationPart.TITLE, (Text)Text.translatable("chat_screen.message", new Object[]{string}));
      }
