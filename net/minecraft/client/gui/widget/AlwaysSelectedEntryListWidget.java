...
public abstract class AlwaysSelectedEntryListWidget extends EntryListWidget {
   ...
   public GuiNavigationPath getNavigationPath(GuiNavigation navigation) {
      if (this.getEntryCount() == 0) {
         ...
         E entry = (E)((Entry)this.getNeighboringEntry(arrow.direction()));
         return entry != null ? GuiNavigationPath.of((ParentElement)this, (GuiNavigationPath)GuiNavigationPath.of(entry)) : null;
      } else if (!this.isFocused()) {
         E entry2 = (E)((Entry)this.getSelectedOrNull());
         if (entry2 == null) {
            entry2 = (E)((Entry)this.getNeighboringEntry(navigation.getDirection()));
         }
