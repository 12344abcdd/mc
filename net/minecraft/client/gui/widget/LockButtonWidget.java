...
public class LockButtonWidget extends ButtonWidget {
   ...
   protected MutableText getNarrationMessage() {
      return ScreenTexts.joinSentences(new Text[]{super.getNarrationMessage(), this.isLocked() ? Text.translatable("narrator.button.difficulty_lock.locked") : Text.translatable("narrator.button.difficulty_lock.unlocked")});
   }
