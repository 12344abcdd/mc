...
public class DirectionalLayoutWidget implements LayoutWidget {
   ...
   public static enum DisplayAxis {
      ...
      void setSpacing(GridWidget grid, int spacing) {
         switch (this.ordinal()) {
            case 0 -> grid.setColumnSpacing(spacing);
            case 1 -> grid.setRowSpacing(spacing);
         }
      ...
      public Widget add(GridWidget grid, Widget widget, int index, Positioner positioner) {
         Widget var10000;
         switch (this.ordinal()) {
            case 0 -> var10000 = grid.add(widget, 0, index, (Positioner)positioner);
            case 1 -> var10000 = grid.add(widget, index, 0, (Positioner)positioner);
