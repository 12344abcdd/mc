...
public abstract class ElementListWidget extends EntryListWidget {
   ...
   public GuiNavigationPath getNavigationPath(GuiNavigation navigation) {
      if (this.getEntryCount() == 0) {
         ...
         E entry = (E)((Entry)this.getFocused());
         if (arrow.direction().getAxis() == NavigationAxis.HORIZONTAL && entry != null) {
            ...
            do {
               entry2 = (E)((Entry)this.getNeighboringEntry(navigationDirection, (element) -> !element.children().isEmpty(), entry2));
               if (entry2 == null) {
                  return null;
               }
   ...
   public abstract static class Entry extends EntryListWidget.Entry implements ParentElement {
      ...
      void appendNarrations(NarrationMessageBuilder builder) {
         ...
         if (selectedElementNarrationData != null) {
            ...
            if (list.size() > 1) {
               builder.put(NarrationPart.POSITION, (Text)Text.translatable("narrator.position.object_list", new Object[]{selectedElementNarrationData.index + 1, list.size()}));
