...
public class CyclingButtonWidget extends PressableWidget {
   ...
   public void appendClickableNarrations(NarrationMessageBuilder builder) {
      ...
      if (this.active) {
         ...
         if (this.isFocused()) {
            builder.put(NarrationPart.USAGE, (Text)Text.translatable("narration.cycle_button.usage.focused", new Object[]{text}));
         } else {
            builder.put(NarrationPart.USAGE, (Text)Text.translatable("narration.cycle_button.usage.hovered", new Object[]{text}));
         }
      }
   ...
   public static Builder onOffBuilder(Text on, Text off) {
      return (new Builder((value) -> value ? on : off)).values((Collection)BOOLEAN_VALUES);
   }

   public static Builder onOffBuilder() {
      return (new Builder((value) -> value ? ScreenTexts.ON : ScreenTexts.OFF)).values((Collection)BOOLEAN_VALUES);
   }
   ...
   public static class Builder {
      ...
      private Object value;
      private final Function valueToText;
      private SimpleOption.TooltipFactory tooltipFactory = (value) -> null;
   ...
   public interface Values {
      ...
      static Values of(final BooleanSupplier alternativeToggle, List defaults, List alternatives) {
         ...
         return new Values(alternativeToggle, list2, list) {
            public List getCurrent() {
