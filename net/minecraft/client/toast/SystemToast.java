...
public class SystemToast implements Toast {
   ...
   public static void addFileDropFailure(MinecraftClient client, int count) {
      add(client.getToastManager(), SystemToast.Type.FILE_DROP_FAILURE, Text.translatable("gui.fileDropFailure.title"), Text.translatable("gui.fileDropFailure.detail", new Object[]{count}));
   }
   ...
   public static void addChunkLoadFailure(MinecraftClient client, ChunkPos pos) {
      show(client.getToastManager(), SystemToast.Type.CHUNK_LOAD_FAILURE, Text.translatable("chunk.toast.loadFailure", new Object[]{Text.of(pos)}).formatted(Formatting.RED), Text.translatable("chunk.toast.checkLog"));
   }

   public static void addChunkSaveFailure(MinecraftClient client, ChunkPos pos) {
      show(client.getToastManager(), SystemToast.Type.CHUNK_SAVE_FAILURE, Text.translatable("chunk.toast.saveFailure", new Object[]{Text.of(pos)}).formatted(Formatting.RED), Text.translatable("chunk.toast.checkLog"));
   }
