...
public class MessageHandler {
   ...
   public void setChatDelay(double chatDelay) {
      long l = (long)(chatDelay * (double)1000.0F);
   ...
   static {
      VALIDATION_ERROR_TEXT = Text.translatable("chat.validation_error").formatted(new Formatting[]{Formatting.RED, Formatting.ITALIC});
   }
