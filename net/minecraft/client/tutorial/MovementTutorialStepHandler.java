...
public class MovementTutorialStepHandler implements TutorialStepHandler {
   ...
   private static final Text MOVE_TITLE = Text.translatable("tutorial.move.title", new Object[]{TutorialManager.keyToText("forward"), TutorialManager.keyToText("left"), TutorialManager.keyToText("back"), TutorialManager.keyToText("right")});
