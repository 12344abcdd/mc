...
public class InputUtil {
   ...
   public static Key fromTranslationKey(String translationKey) {
      if (InputUtil.Key.KEYS.containsKey(translationKey)) {
         ...
         for(Type type : InputUtil.Type.values()) {
   ...
   public static enum Type {
      ...
      MOUSE("key.mouse", (buttonCode, translationKey) -> Language.getInstance().hasTranslation(translationKey) ? Text.translatable(translationKey) : Text.translatable("key.mouse", new Object[]{buttonCode + 1}));
