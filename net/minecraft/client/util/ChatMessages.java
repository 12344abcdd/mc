...
public class ChatMessages {
   ...
   public static List breakRenderedChatMessageLines(StringVisitable message, int width, TextRenderer textRenderer) {
      ...
      textRenderer.getTextHandler().wrapLines(textCollector.getCombined(), width, Style.EMPTY, (BiConsumer)((text, lastLineWrapped) -> {
      ...
      return (List)(list.isEmpty() ? Lists.newArrayList(new OrderedText[]{OrderedText.EMPTY}) : list);
   }
