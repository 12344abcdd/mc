...
public class ModelPredicateProviderRegistry {
   ...
   static {
      ...
      register(Identifier.ofVanilla("cooldown"), (stack, world, entity, seed) -> entity instanceof PlayerEntity ? ((PlayerEntity)entity).getItemCooldownManager().getCooldownProgress(stack.getItem(), 0.0F) : 0.0F);
      ...
      registerCustomModelData((stack, world, entity, seed) -> (float)((CustomModelDataComponent)stack.getOrDefault(DataComponentTypes.CUSTOM_MODEL_DATA, CustomModelDataComponent.DEFAULT)).value());
      ...
      register(Items.BRUSH, Identifier.ofVanilla("brushing"), (stack, world, entity, seed) -> entity != null && entity.getActiveItem() == stack ? (float)(entity.getItemUseTimeLeft() % 10) / 10.0F : 0.0F);
      register(Items.BOW, Identifier.ofVanilla("pulling"), (stack, world, entity, seed) -> entity != null && entity.isUsingItem() && entity.getActiveItem() == stack ? 1.0F : 0.0F);
      ...
      register(Items.CLOCK, Identifier.ofVanilla("time"), new ClampedModelPredicateProvider() {
         ...
         private double getTime(World world, double skyAngle) {
            if (world.getTime() != this.lastTick) {
               ...
               this.step += d * 0.1;
               this.step *= 0.9;
               this.time = MathHelper.floorMod(this.time + this.step, (double)1.0F);
            }
      ...
      register(Items.COMPASS, Identifier.ofVanilla("angle"), new CompassAnglePredicateProvider((world, stack, entity) -> {
         ...
         return lodestoneTrackerComponent != null ? (GlobalPos)lodestoneTrackerComponent.target().orElse((Object)null) : CompassItem.createSpawnPos(world);
      }));
      register(Items.RECOVERY_COMPASS, Identifier.ofVanilla("angle"), new CompassAnglePredicateProvider((world, stack, entity) -> {
      ...
      register(Items.CROSSBOW, Identifier.ofVanilla("pulling"), (stack, world, entity, seed) -> entity != null && entity.isUsingItem() && entity.getActiveItem() == stack && !CrossbowItem.isCharged(stack) ? 1.0F : 0.0F);
      ...
      register(Items.SHIELD, Identifier.ofVanilla("blocking"), (stack, world, entity, seed) -> entity != null && entity.isUsingItem() && entity.getActiveItem() == stack ? 1.0F : 0.0F);
      register(Items.TRIDENT, Identifier.ofVanilla("throwing"), (stack, world, entity, seed) -> entity != null && entity.isUsingItem() && entity.getActiveItem() == stack ? 1.0F : 0.0F);
      ...
      register(Items.GOAT_HORN, Identifier.ofVanilla("tooting"), (stack, world, entity, seed) -> entity != null && entity.isUsingItem() && entity.getActiveItem() == stack ? 1.0F : 0.0F);
   }
}
