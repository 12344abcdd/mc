...
public class SpaceFont implements Font {
   ...
   public static record Loader(Map advances) implements FontLoader {
      public static final MapCodec CODEC = RecordCodecBuilder.mapCodec((instance) -> instance.group(Codec.unboundedMap(Codecs.CODEPOINT, Codec.FLOAT).fieldOf("advances").forGetter(Loader::advances)).apply(instance, Loader::new));
